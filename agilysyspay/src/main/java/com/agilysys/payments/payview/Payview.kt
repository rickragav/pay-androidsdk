package com.agilysys.payments.payview
...
import com.agilysys.payments.payview.commons.AnimationType
  ...
  /*  @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    private fun initData(){
        payModel = PayModel(
            ...
            tv_card_month.text.toString(),
            tv_card_year.text.toString(),
            "${tv_card_one.text}${tv_card_two.text}${tv_card_three.text}${tv_card_four.text.trim()}",
